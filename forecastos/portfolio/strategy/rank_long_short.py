...
class RankLongShort(BaseStrategy):
    ...
    Attributes
    ----------
    costs : list[:py:class:`~forecastos.portfolio.cost_model.base_cost.BaseCost`]
    ...
    def generate_trade_list(self, holdings: pd.Series, t: dt.datetime) -> pd.Series:
        """Calculates and returns trade list (in units of currency passed in) by going long top :py:attr:`~forecastos.portfolio.strategy.rank_long_short.RankLongShort.percent_long` assets and short bottom :py:attr:`~forecastos.portfolio.strategy.rank_long_short.RankLongShort.percent_short` assets.
