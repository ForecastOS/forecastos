...
from forecastos.portfolio.result.save_result import SaveResult
from forecastos.util import clip_for_dates
...
class BaseResult(SaveResult, HydrateMixin):
    ...
    Instances of this object are called by the :py:meth:`forecastos.portfolio.controller.Controller.generate_positions` method.
    """
    ...
    def summary(self) -> None:
        ...
        (e.g. :py:attr:`~forecastos.portfolio.result.base_result.BaseResult.num_periods`, :py:attr:`~forecastos.portfolio.result.base_result.BaseResult.sharpe_ratio`, :py:attr:`~forecastos.portfolio.result.base_result.BaseResult.max_drawdown`, etc.).
        """
    ...
    def _summary_string(self) -> str:
        ...
        Do not call directly; call :py:attr:`~forecastos.portfolio.result.base_result.BaseResult.summary` instead.
        """
    ...
    def periods_per_year(self) -> float:
        ...
        Calculated as :py:attr:`~forecastos.portfolio.result.base_result.BaseResult.num_periods` / :py:attr:`~forecastos.portfolio.result.base_result.BaseResult.years_forecast`
        """
    ...
    def information_ratio(self, use_annualized_inputs=True) -> float:
        ...
        Ratio is calculated as mean of :py:attr:`~forecastos.portfolio.result.base_result.base_result.BaseResult.excess_returns` / standard deviation of :py:attr:`~forecastos.portfolio.result.base_result.BaseResult.excess_returns`. Annualized by multiplying ratio by square root of periods per year (:py:attr:`~forecastos.portfolio.result.base_result.BaseResult.periods_per_year`).
        """
