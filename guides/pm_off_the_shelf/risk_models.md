...
from forecastos.portfolio.risk_model import *
...
PM provides the following risk models:

## FactorRisk

[FactorRisk](https://github.com/ForecastOS/forecastos/tree/v0.3.10/forecastos/portfolio/risk_model/factor_risk.py) is a multi-factor risk model.
...
[StatFactorRisk](https://github.com/ForecastOS/forecastos/tree/v0.3.10/forecastos/portfolio/risk_model/stat_factor_risk.py) creates a PCA-factor based risk model from `actual_returns`. To use this model, there must be more periods in `actual_returns` than assets in your investment strategy.
...
Want to explore creating your own custom risk model? Check out [Custom Risk Models](/guides/pm_bespoke/custom_risk_models).

Want to explore an end-to-end example? Check out [Single Period Optimization](/guides/pm_simple_examples/spo).
