...
PM provides the following optimization strategies:
...
-   [SPO](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/strategy/spo.py) (Single Period Optimization)
...
-   [SPOTranches](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/strategy/spo_tranches.py) (Single Period Optimization Tranches)
    ...
    -   Uses [CVXPY](https://www.cvxpy.org/tutorial/intro/index.html)
    - **Optimization**: maximizes expected return, less costs, while adhering to constraints
-   [SPOWeights](https://github.com/ForecastOS/forecastos/tree/v0.6.3/forecastos/portfolio/strategy/spo_weights.py) (Single Period Optimization Weights)
...
```python
from forecastos.portfolio.strategy import RankLongShort
...
backtest_controller = fos.portfolio.BacktestController(
    strategy=strategy
)
```
...
Like RankLongShort, or any other PM investment strategy, once instantiated, you can use the `generate_trade_list` method to get trades for a given datetime:
...
Want to explore creating your own custom investment strategy? Check out [Custom Investment Strategies](/guides/pm_bespoke/custom_investment_strategies).

Want to learn more about using cost models? Check out [Cost Models](/guides/pm_off_the_shelf/cost_models).
