<h1>Why Portfolio Management (PM)</h1>

Portfolio management (PM), our open-source portfolio engineering and optimization engine, is built to help institutional investors turn research signals into *real, investable portfolios* with clarity, control, and discipline.

Most portfolio tools break down when real-world constraints, transaction costs, and evolving signals are introduced. PM is designed from the ground up to handle those realities while remaining transparent, flexible, and production-ready.

## The Core Idea

* **Portfolio engineering, not black boxes:** PM provides explicit, controllable portfolio construction logic rather than opaque optimizers.
...
* **Integrate seamlessly:** use PM alongside ForecastOS FeatureHub and Hivemind, or plug in your own signals and risk models.
...
* **Institutions need transparency.** PM makes portfolio decisions auditable, explainable, and defensible to stakeholders.
...
* **Fully open-source:** PM is available on GitHub, allowing teams to inspect, extend, and trust the portfolio construction logic.
...
Let's explore [How PM Works](/guides/portfolio_management_(pm)_introduction/how_pm_works) next.
