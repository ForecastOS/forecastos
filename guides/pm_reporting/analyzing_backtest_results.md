...
The [BaseResult](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/result/base_result.py) class captures portfolio data and calculates performance metrics for your investment strategy.
...
It's possible to backtest a portfolio created outside of PM. Let's review how that works: [Analyzing External Portfolios](/guides/pm_reporting/external_portfolios).
