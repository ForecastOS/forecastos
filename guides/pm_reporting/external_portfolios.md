...
If your portfolio was created outside of PM, you can still use PM to review its performance.
...
from forecastos.portfolio.result import WeightsResult
...
Getting the `result` backtest object takes a few more steps for portfolios created outside of ForecastOS PM, but you end up with the same `result` object.
...
To view all of the reporting functionality available to you, [check out the result class on Github](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/result/base_result.py).

Looking for more reporting? Consider extending the [BaseResult](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/result/base_result.py) class, or opening a pull request [on GitHub](https://github.com/ForecastOS/forecastos)!

## Next: Backtest Controller

Next, let's explore the BacktestController class, which coordinates backtesting your chosen investment strategy: [Backtest Controller](/guides/pm_off_the_shelf/backtest_controller).
