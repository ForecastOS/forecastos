...
In order to backtest a portfolio using [RankLongShort](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/strategy/rank_long_short.py), we'll need:
...
strategy = fos.portfolio.strategy.RankLongShort(
...
If you have a charting library installed, like matplotlib, check out [BaseResult](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/result/base_result.py) for the many metrics you can plot, like:
...
-   Assumed our initial portfolio was all cash
    -   You can override this by setting the `initial_portfolio` kwarg equal to a (Pandas) series of asset values when initializing [BacktestController](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/backtest_controller.py#L19).

## Next: Single Period Optimization

Next, let's explore adding cost and constraint models in our next guide: [Single Period Optimization](/guides/pm_simple_examples/spo).
