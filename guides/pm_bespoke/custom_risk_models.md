...
The [BaseRisk](https://github.com/ForecastOS/forecastos/tree/v0.3.10/forecastos/portfolio/risk_model/base_risk.py) class provides a foundational structure for creating custom risk models.
...
See [FactorRisk](https://github.com/ForecastOS/forecastos/tree/v0.3.10/forecastos/portfolio/risk_model/factor_risk.py) for inspiration:
