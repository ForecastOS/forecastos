...
The [BaseCost](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/cost_model/base_cost.py) class provides a foundational structure for creating custom cost models.
...
See [ShortHoldingCost](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/cost_model/short_holding_cost.py) for inspiration:
...
Want to explore creating your own custom cost model? Check out [Custom Constraint Models](/guides/pm_bespoke/custom_constraint_models).