...
The [BaseConstraint](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/constraint_model/base_constraint.py) class provides a foundational structure for creating custom constraint models.
...
See [MaxLeverageConstraint](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/constraint_model/leverage_constraint.py) for inspiration:
