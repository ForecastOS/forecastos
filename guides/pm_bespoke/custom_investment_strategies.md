...
The [BaseStrategy](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/strategy/base_strategy.py) class provides a foundational structure for creating custom investment strategies.
...
from forecastos.util import get_value_at_t
```
...
Both [RankLongShort](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/strategy/rank_long_short.py) and [SPO](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/strategy/spo.py) classes, which extend [BaseStrategy](https://github.com/ForecastOS/forecastos/tree/v0.3.9/forecastos/portfolio/strategy/base_strategy.py), offer a base foundation for implementing investment strategies.
...
Want to explore creating your own custom cost model? Check out [Custom Cost Models](/guides/pm_bespoke/custom_cost_models).