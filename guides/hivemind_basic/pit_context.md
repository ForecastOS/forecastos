...
PIT context can be generated and explored in the ForecastOS UI, where users can view point-in-time summaries, key events, and discussion volume for a given topic over time.
